...
<li style="margin-top: 10px">
    ...
    is a .NET application written in C# to remotely manage Transmission.
</li>
<li style="margin-top: 10px">
    ...
    He's also been providing technical support in the forums.
</li>
...
<li style="margin-top: 10px"><a href="http://forum.transmissionbt.com/memberlist.php?mode=viewprofile&u=9261">fagga</a>
    ...
    for Transmission written in Python.
</li>
<li style="margin-top: 10px">
...
<li style="margin-top: 10px">
    ...
    also for use on Mac OS X.
</li>
<li style="margin-top: 10px">
    <a href="http://code.google.com/p/transmisson-remote-gui/">transmission-remote-gui</a>
    is an application written in Free Pascal to remotely manage Transmission.
</li>
<li style="margin-top: 10px">
    <a href="http://code.google.com/p/selene-transmission">selene-transmission</a>
    is a GTK+ application written in Python to remotely manage Transmission.
</li>
<li style="margin-top: 10px">
...
<li style="margin-top: 10px">
    ...
    to communicate with Transmission through json-rpc.
</li>
<li style="margin-top: 10px">
	<a href="http://www.kryogenix.org/days/">Stuart Langridge</a> has a <a href="http://www.kryogenix.org/days/2008/11/15/pause-torrents-while-im-using-the-computer">20-line python script</a> for <a href="http://www.gnome.org/">GNOME</a> that enables Transmission only when his screensaver is on.  Shivan has a <a href="http://www.kryogenix.org/days/2008/11/15/pause-torrents-while-im-using-the-computer#comment-122877">tweak</a> to change the speed limits instead.</li>
<li style="margin-top: 10px">
	nstehr has created an <a href="http://code.google.com/p/torrent-bot/">MSN Messenger bot</a>, which interacts with Transmission daemon through json-rpc.
</li> 
