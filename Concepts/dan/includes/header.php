	...
	<body>
		<div id="header">
			<div class="meat">
				...
				<div id="nav">
					<ul>
						<li><a <?php echo $index; ?> href="index.php">Main</a></li>
						<li><a <?php echo $about; ?> href="about.php">About</a></li>
						<li><a <?php echo $download; ?> href="download.php">Download</a></li>
						<li><a href="http://trac.transmissionbt.com">Development &amp; Support</a></li>
						<li><a <?php echo $resources; ?> href="resources.php">Add-Ons</a></li>
						
						<li style="float: right;"><a href="http://forum.transmissionbt.com">Forum</a></li>
